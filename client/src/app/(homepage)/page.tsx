                ...
                <div className="card-body bg-light p-4">
                  ...
                  <div className="d-flex mb-3">
                    <small className="mr-2">
                      <i className="fa fa-user text-muted"></i> Admin
                    </small>
                    <small className="mr-2">
                      <i className="fa fa-folder text-muted"></i> Web Design
                    </small>
                    <small className="mr-2">
                      <i className="fa fa-comments text-muted"></i> 15
                    </small>
                  </div>
                  <p>
                    Diam amet eos at no eos sit lorem, amet rebum ipsum clita
                    stet, diam sea est diam eos, rebum sit vero stet justo
                  </p>
